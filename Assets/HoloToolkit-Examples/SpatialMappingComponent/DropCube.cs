...
public class DropCube : MonoBehaviour
{
    ...
    public GameObject sphereBallPrefab;
    ...
    private void Recognizer_TappedEvent(InteractionSourceKind source, int tapCount, Ray headRay)
    {
        ...
        GameObject newSphereBall = (GameObject) Instantiate(sphereBallPrefab);
        newSphereBall.transform.localScale = Vector3.one * 0.3f; // Make the cube smaller
        newSphereBall.transform.position = Camera.main.transform.position + Camera.main.transform.forward; // Start to drop it in front of the camera
